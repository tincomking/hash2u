  ...
  return (
    <section className="relative z-10 max-w-7xl mx-auto px-6 py-24 lg:py-32">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        {/* Left: description */}
        <ScrollReveal>
          <div className="inline-flex items-center gap-2 rounded-full bg-ai/10 border border-ai-border px-3 py-1 mb-6">
            <span className="text-xs font-mono text-ai tracking-wide">OpenAI Compatible</span>
          </div>
          <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl tracking-tight mb-6 leading-[1.1]">
            One Line Change.
            <br />
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item} className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-ai/10 border border-ai-border flex items-center justify-center flex-shrink-0">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden border border-border bg-bg">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-surface border-b border-border">
                ...
                <span className="text-xs text-text-muted ml-2 font-mono">main.py</span>
              </div>
            ...
            {/* Decorative glows */}
            <div className="absolute -top-6 -right-6 w-40 h-40 bg-ai/[0.08] rounded-full blur-[80px] pointer-events-none" />
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-ai-deep/[0.06] rounded-full blur-[60px] pointer-events-none" />
          </div>
        </ScrollReveal>
      </div>
    </section>
...
function Line({ n, children }: { n: number; children?: React.ReactNode }) {
  return (
    <div className="flex">
      <span className="w-8 text-right text-text-muted/40 select-none mr-4">{n}</span>
